...
function outputHeader($title){              //Ouputs the header for the page and opening body tag
    ...
    echo '<script src="js/danielScripts.js"></script>';                 // importing the scripts java file
    echo '<script src="js/game2.js"></script>';                  // Create link to my JavaScript file    
...
{           // Start navigation bar    
    echo   '<nav class="navbar navbar-inverse navbar-static-top">';              // Navigation bar
    echo    '   <div class="container">';

    echo           '<div class="navbar-header">';
    echo          '<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false"  aria-controls="navbar">';                   //Navigation bar tabs
    echo          '<span class="sr-only">Toggle navigation</span>';
    echo      '<span class="icon-bar"></span>';
    echo  '<span class="icon-bar"></span>';
    echo   '<span class="icon-bar"></span>';
    echo '</button>';
    echo '<a class="navbar-brand " href="index.php" >THE ROAD LAYER</a>';    //Home button / link to home page
    echo  '</div>';
...
;    echo  '<ul class="nav navbar-nav navbar-right">';
    ...
    echo   '</ul>';
     echo    ' <img src="/assets/works.gif" height="40" width="80">';
...
function outputFooter(){
    ...
    echo    '<footer class="footer">';                                                                          //Footer of the page
